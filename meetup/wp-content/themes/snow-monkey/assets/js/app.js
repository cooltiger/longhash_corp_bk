(function ($) {
	...
	$.fn.SnowMonkeyWpawPrBox = function () {
	  return this.each(function (i, e) {
	    ...
	    prbox.parents().each(function (i, e) {
	      var parent = $(e);
	...
	var Inc2734_WP_Share_Buttons_GooglePlus = function (_Inc2734_WP_Share_But) {
	  inherits(Inc2734_WP_Share_Buttons_GooglePlus, _Inc2734_WP_Share_But);

	  function Inc2734_WP_Share_Buttons_GooglePlus(button, params) {
	    classCallCheck(this, Inc2734_WP_Share_Buttons_GooglePlus);
	    return possibleConstructorReturn(this, (Inc2734_WP_Share_Buttons_GooglePlus.__proto__ || Object.getPrototypeOf(Inc2734_WP_Share_Buttons_GooglePlus)).call(this, button, params));
	  }

	  createClass(Inc2734_WP_Share_Buttons_GooglePlus, [{
	    key: 'popup',
	    value: function popup() {
	      new Inc2734_WP_Share_Buttons_Popup(this.button.find('.wp-share-button__button'), 'Google Plus', 400, 620);
	    }
	  }]);
	  return Inc2734_WP_Share_Buttons_GooglePlus;
	}(Inc2734_WP_Share_Buttons_Button);
	...
	var Inc2734_WP_Share_Buttons = function Inc2734_WP_Share_Buttons() {
	  ...
	  $(function () {
	    ...
	    $('.wp-share-button--google-plus').each(function (i, e) {
	  ...
	  createClass(SnowMonkeyDropNav, [{
	    ...
	    value: function onScroll() {
	      ...
	      $(window).scroll(function () {
	        ...
	        setTimeout(function () {
	          if (_this.min < $(window).width()) {
	            if (_this.header.outerHeight() < $(window).scrollTop()) {
	    ...
	    value: function onResize() {
	      ...
	      $(window).resize(function () {
	        if ($(window).width() === _this2.defaultWindowWidth) {
	          return;
	        }
